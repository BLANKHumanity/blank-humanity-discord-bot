...
class FunPlaceBuyItemCommandTest
    extends CommandUnitTest<FunPlaceBuyItemCommand> {
    ...
    void testBuyItem(@Mock BlankUser user) {
        ...
        mockServiceCreateFormatting(user, FunPlaceMessageType.BUY_ITEM_SUCCESS);

        mockMessageFormats(FunPlaceMessageType.BUY_ITEM_SUCCESS,
    ...
    void testBuyItemNoSupply(@Mock BlankUser user) {
        ...
        mockServiceCreateFormatting(user,
            FunPlaceMessageType.BUY_ITEM_NO_SUPPLY);

        mockMessageFormats(FunPlaceMessageType.BUY_ITEM_NO_SUPPLY,
            "%(shopItemId):%(shopItemBuyName):%(itemName):%(itemAmount)");
    ...
    void testBuyItemNotEnoughMoney(@Mock BlankUser user) {
        ...
        mockServiceCreateFormatting(user,
            FunPlaceMessageType.BUY_ITEM_NOT_ENOUGH_MONEY);

        mockMessageFormats(FunPlaceMessageType.BUY_ITEM_NOT_ENOUGH_MONEY,
            "%(shopItemId):%(shopItemBuyName):%(itemName):%(itemAmount)");
    ...
    void testBuyNonExistingItem(@Mock BlankUser user) {
        ...
        mockServiceCreateFormatting(user, FunPlaceMessageType.ITEM_NOT_EXISTS);

        mockMessageFormats(FunPlaceMessageType.ITEM_NOT_EXISTS,
            "%(itemName)");
